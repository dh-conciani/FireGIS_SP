...
## List LAFirA files
dest <- list.files ("./qa_S30MB1HA_JD/", pattern = ".tif$", full.names=T)
file <- list.files ("./qa_S30MB1HA_JD/", pattern = ".tif$", full.names=F)
...
## Export db
write.table(db_lafira, "./product_db/filtered_db_julian.txt")
