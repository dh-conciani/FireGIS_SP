...
raster_loc <- list.files(path = './train_scenes/assis/TM', pattern = '.tif$', full.names = T)
ba_loc <- list.files(path = './train_pols/burned_area/assis/', pattern = '.shp$', full.names = T)
const_loc <- list.files(path = './train_pols/construction/assis/', pattern = '.shp$', full.names = T)
esoil_loc <- list.files(path = './train_pols/e_soil/assis/', pattern = '.shp$', full.names = T)
gcover_loc <- list.files(path = './train_pols/green_cover/assis/', pattern = '.shp$', full.names = T)
harv_loc <- list.files(path = './train_pols/harvest/assis/', pattern = '.shp$', full.names = T)
road_loc <- list.files(path = './train_pols/road/assis/', pattern = '.shp$', full.names = T)
shadow_loc <- list.files(path = './train_pols/shadow/assis/', pattern = '.shp$', full.names = T)
water_loc <- list.files(path = './train_pols/water/assis/', pattern = '.shp$', full.names = T)
...
BA_TM_data_entries <- data.frame (NULL)
...
for (i in 1:list_count) {
  ...
  ## build data.frame
  BA_TM_data_entries <- rbind (BA_TM_data_entries, temp)
}
...
# Create a data.frame to receive data
CONST_TM_data_entries <- data.frame (NULL)
...
for (i in 1:list_count) {
  ...
  temp <- data.frame (bname, date, class, sensor, temp)
  ## build data.frame
  CONST_TM_data_entries <- rbind (CONST_TM_data_entries, temp)
}
...
# Create a data.frame to receive data
ESOIL_TM_data_entries <- data.frame (NULL)
...
for (i in 1:list_count) {
  ...
  temp <- data.frame (bname, date, class, sensor, temp)
  ## build data.frame
  ESOIL_TM_data_entries <- rbind (ESOIL_TM_data_entries, temp)
}
...
# Create a data.frame to receive data
GCOVER_TM_data_entries <- data.frame (NULL)
...
for (i in 1:list_count) {
  ...
  temp <- data.frame (bname, date, class, sensor, temp)
  ## build data.frame
  GCOVER_TM_data_entries <- rbind (GCOVER_TM_data_entries, temp)
}
...
# Create a data.frame to receive data
HARV_TM_data_entries <- data.frame (NULL)
...
for (i in 1:list_count) {
  ...
  temp <- data.frame (bname, date, class, sensor, temp)
  ## build data.frame
  HARV_TM_data_entries <- rbind (HARV_TM_data_entries, temp)
}
...
# Create a data.frame to receive data
ROAD_TM_data_entries <- data.frame (NULL)
...
for (i in 1:list_count) {
  ...
  temp <- data.frame (bname, date, class, sensor, temp)
  ## build data.frame
  ROAD_TM_data_entries <- rbind (ROAD_TM_data_entries, temp)
}
...
# Create a data.frame to receive data
SHADOW_TM_data_entries <- data.frame (NULL)
...
for (i in 1:list_count) {
  ...
  temp <- data.frame (bname, date, class, sensor, temp)
  ## build data.frame
  SHADOW_TM_data_entries <- rbind (SHADOW_TM_data_entries, temp)
}
...
# Create a data.frame to receive data
WATER_TM_data_entries <- data.frame (NULL)
...
for (i in 1:list_count) {
  ...
  temp <- data.frame (bname, date, class, sensor, temp)
  ## build data.frame
  WATER_TM_data_entries <- rbind (WATER_TM_data_entries, temp)
}

## merge 
df_TM <- rbind (BA_TM_data_entries, CONST_TM_data_entries, ESOIL_TM_data_entries,
             GCOVER_TM_data_entries, HARV_TM_data_entries, ROAD_TM_data_entries,
             SHADOW_TM_data_entries, WATER_TM_data_entries)
...
rm (df, df_poly, df_raster, poly_dates, poly_list_count, poly_list_names, 
    ...
    r_test, pol_ref, BA_TM_data_entries, CONST_TM_data_entries, df_ba, df_const,
    df_esoil, df_gcover, df_harv, df_road, df_shadow, df_water, ESOIL_TM_data_entries,
    GCOVER_TM_data_entries, HARV_TM_data_entries, match_ba, match_const, match_esoil,
    match_gcover, match_harv, match_road, match_shadow, match_water, ROAD_TM_data_entries,
    SHADOW_TM_data_entries, WATER_TM_data_entries, ba_dates, ba_list_names,
